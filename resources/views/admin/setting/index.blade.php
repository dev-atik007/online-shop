                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                     ...
                     <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Setting Details</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 text-center">
                                        ...
                                        <img class="w-100 border-radius-lg shadow-lg mx-auto"
                                            src="{{ '/uploads/settings' . $setting->image }}" alt="{{ $setting->image . 'image' }}">
                                        <br>
                                        <h5>Site Logo : </h5>
                                        <img class="w-100 border-radius-lg shadow-lg mx-auto"
                                        src="{{ '/uploads/settings' . $setting->logo}}" alt="{{ $setting->logo . 'logo' }}">
                                    </div>
