                                    ...
                                    <table id="data_table_set" class="table table-info table-responsive table-striped table-hover">
                                        ...
                                        <tbody class="table-group-divider">
                                            ...
                                            <tr>
                                                    ...
                                                    <td scope="col">{{ $customer->image }}</td>
                                                    <td scope="col">{{ $customer->phone }}</td>
                                                    <td scope="col">{{ $customer->address }}</td>
                                                    <td scope="col">{{ $customer->status }}</td>
                                                    <td>
                                                        <a href="" data-toggle="tooltip" title="SMS" data-placement="bottom" class="btn btn-outline-success btn-sm"><img src="{{url('icon/chat.svg')}}" alt="" srcset=""></a>
                                                        <a href="{{ route('admin.customer.edit', $customer->id) }}" data-toggle="tooltip" title="View" data-placement="bottom" class="btn btn-outline-success btn-sm"><img src="{{url('icon/eye.svg')}}" alt="" srcset=""></a>
