                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <a class="btn btn-outline-info float-left"
                                        href="{{ route('category.list') }}">Category List</a>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <form class="m-3" action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            <label for="is_parent">@lang('Is Parent or Not')</label>
                                            <select class="form-control" id="is_parent" name="is_parent" required>
                                                <option value="0" {{ old('is_parent')== 0?'selected':'' }}>@lang('Parent')</option>
                                                <option value="1" {{ old('is_parent')== 1?'selected':'' }}>@lang('Sub-Category')</option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="mb-3">
                                                    <label for="photo" class="form-label">Category Photos :<span
                                                            class="text-danger"> *</span></label>
                                                    <input type="file" class="form-control" id="image" name="categoryImage">
                                                </div>
                                            </div>
                                        </div>
...
<script>
        ...
        var parentCheck = $('#is_parent').val();
        // alert(parentCheck);
                console.log(parentCheck);
                if(parentCheck == 0)
                {
                    $('#parent_cat_div').addClass('d-none');
                    $('#category_name').attr('required', false);
                    $('#category_name').val('');
